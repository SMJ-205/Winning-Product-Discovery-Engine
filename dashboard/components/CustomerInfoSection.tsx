...
const AGE_DATA = [
  { name: '<25', value: 14, color: '#f43f5e' },
  { name: '25-34', value: 28, color: '#ec4899' },
  { name: '35-44', value: 24, color: '#d946ef' },
  { name: '45-54', value: 18, color: '#a855f7' },
  { name: '55-64', value: 11, color: '#8b5cf6' },
  { name: '>64', value: 5, color: '#6366f1' },
]
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '0.75rem' }}>
          <div style={{ width: 130, height: 130, position: 'relative' }}>
            ...
            <div style={{
              ...
              <div style={{ fontSize: '0.9rem', fontWeight: 800, color: '#f8fafc' }}>28%</div>
              <div style={{ fontSize: '0.5625rem', color: '#94a3b8' }}>25-34</div>
            </div>
          </div>
          ...
          <div style={{
            ...
            {AGE_DATA.map(d => (
              <div key={d.name} style={{ display: 'flex', alignItems: 'center', gap: 5, fontSize: '0.7rem' }}>
                ...
                <b style={{ color: '#f8fafc' }}>{d.value}%</b>
              </div>
            ))}
          </div>
        </div>
          ...
          {REGIONS.map(r => (
            <div key={r.name}>
              <div style={{ display: 'flex', justifyContent: 'space-between', fontSize: '0.75rem', marginBottom: 4 }}>
                ...
                <span style={{ fontWeight: 800, color: '#38bdf8' }}>{r.pct}%</span>
              </div>
              <div style={{
                width: '100%',
                height: 6,
      ...
      <div style={{
        ...
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: 6 }}>
            ...
            <span style={{ fontSize: '0.75rem', color: '#cbd5e1', fontWeight: 600 }}>{t('female')}</span>
            <b style={{ fontSize: '0.875rem', color: '#ec4899' }}>54%</b>
          </div>
          <div style={{ display: 'flex', alignItems: 'center', gap: 6 }}>
            <span style={{ width: 8, height: 8, borderRadius: '50%', background: '#38bdf8' }} />
            <span style={{ fontSize: '0.75rem', color: '#cbd5e1', fontWeight: 600 }}>{t('male')}</span>
            <b style={{ fontSize: '0.875rem', color: '#38bdf8' }}>46%</b>
          </div>
        </div>
      </div>
    </div>
